...
import { CreateCollectionTask } from './tasks/create-collection.task.js';
import { DeleteAiContextAdminTask } from './tasks/delete-ai-context-admin.task.js';
import { DeleteCollectionTask } from './tasks/delete-collection.task.js';
...
import { UpdateCollectionTask } from './tasks/update-collection.task.js';
...
adminRouter.post('/collections', CreateCollectionTask.handler());
adminRouter.patch('/collections/:id', UpdateCollectionTask.handler());
adminRouter.delete('/collections/:id', DeleteCollectionTask.handler());
