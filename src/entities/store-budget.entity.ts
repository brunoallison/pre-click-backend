...
@Entity({ name: 'store_budget', comment: 'Budget por (store, collection).' })
@Index('store_budget_unique', ['store_id', 'collection_id'], { unique: true })
@Index('store_budget_tenant_collection', ['tenant_id', 'collection_id'])
export class StoreBudget {
